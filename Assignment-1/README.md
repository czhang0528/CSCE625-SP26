...
* Due date and time: February 10th (Tuesday), 23:59 PM CST
...
Download or clone this repository. This code, and the idea for the assignment, comes from [UC Berkeley](https://ai.berkeley.edu/home.html).
...
```
* The full grade shown in the autograder is 50.
